...
class PageSaver:
    ...
    def save_list_to_file(self, list, path): ### UNUSED IN THIS FILE
        try:
    ...
    def load_list_from_file(self, in_file): ### UNUSED IN THIS FILE
        try:
    ...
    def save_new_meta_file(self, meta_list, link_list, text_list, raw_data, path):
    ...
    def save_website(self, search_url):
        ...
        meta_list_file = self.website_path(website_name)
        # Save page
        self.save_new_meta_file(meta_list, link_list, text_list, raw_file_data, meta_list_file)
